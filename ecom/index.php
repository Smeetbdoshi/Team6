...
<body>
    <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav ml-auto">
                            ...
                            <?php }else{ ?>
                                ...
                                <a class="nav-link navbar-text-style-nbs" href="cart.php">Cart</a>
               ...
               while ($data = $result->fetch_assoc()) { ?>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="p-3 card-es mb-3 shadow">
                        <h1 class="card-title-es"><?php echo $data['product_name']; ?></h1>
                        <div class="card-image-container-es">
                            <img src="images/<?php echo $data['product_image']; ?>" class="card-image-es" />
                        </div>
        ...
        <div id="sectionFooter" class="container-fluid bg-container-fs pt-5 pb-5">
            <div class="row pl-4">
